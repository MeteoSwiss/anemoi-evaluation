...
built and validated against at v0.1.0. How they are met is in
...
In scope at v0.1.0: deterministic and ensemble forecasts from a single-dataset anemoi checkpoint,
...
not fully met at v0.1.0 carries a **Status** line.
...
Deliberate non-goals at v0.1.0. Each is a decision, not an oversight.
